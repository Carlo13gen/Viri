#!/usr/bin/env bash
dropdb --if-exists "Viri" && createdb "Viri" && psql -d "Viri" -c "DROP TABLE IF EXISTS utente, file CASCADE;" -c "CREATE TABLE utente (username varchar(20) NOT NULL PRIMARY KEY, nome varchar(20) NOT NULL, cognome varchar(20) NOT NULL,
